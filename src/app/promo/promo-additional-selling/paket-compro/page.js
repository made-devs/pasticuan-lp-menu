...
import { paketCompro } from "@/data/promoAdditionalSelling";

export default function PaketComproPage() {
  ...
  return (
    <div className="w-full max-w-[430px] mx-auto min-h-screen text-white font-montserrat relative overflow-hidden px-4 pb-10">
      ...
      {/* Product List */}
      <ProductList products={paketCompro} onSelect={setSelectedProduct} />
