...
import "swiper/css";
import "swiper/css/navigation"; // <- tambahkan ini
import { Pagination } from "swiper/modules"; // <- tambahkan ini
import Image from "next/image";
import Link from "next/link";

export default function ImageCarouselXL({ title, category, href, dataSource }) {
  ...
  return (
    <div className="w-full mb-6">
      ...
      <Swiper
        ...
        spaceBetween={16}
        slidesPerView={1.2}
        pagination={{ type: "progressbar" }} // <- Ganti jadi progressbar
      >
