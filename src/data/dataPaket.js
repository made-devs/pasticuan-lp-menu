...
export const importirPackages = [
  {
    ...
    img_modal:
      "http://pasticuan.co.id/wp-content/uploads/2025/06/PAKET-JASA-IMPORT-BASIC-copy.webp",
    desc_modal:
      "Paket untuk pemula yang ingin mencoba impor dengan modal kecil dan panduan dasar impor.",
  },
  {
    title: "IMPORT KOMPLIT",
    price: "± Rp 50.000.000,-",
    image:
    ...
    img_modal:
      "http://pasticuan.co.id/wp-content/uploads/2025/06/PAKET-JASA-IMPORT-KOMPLIT-copy.webp",
    desc_modal:
      "Dirancang untuk UMKM yang ingin mengembangkan bisnis melalui impor barang secara efisien dan legal.",
  },
  {
    title: "IMPORT SUPER KOMPLIT",
    ...
    img_modal:
      "http://pasticuan.co.id/wp-content/uploads/2025/06/PAKET-JASA-IMPORT-SUPER-KOMPLIT-copy.webp",
    desc_modal:
      "Paket lengkap bagi importir grosir yang ingin mendatangkan barang dalam jumlah besar dengan harga terbaik.",
  },
  {
    title: "IMPORT PRIORITAS",
    price: "± Rp 600.000.000,-",
    image:
      "http://pasticuan.co.id/wp-content/uploads/2025/05/PAKET-JASA-IMPORT-PRIORITAS-copy-2.webp",
    img_modal:
      "http://pasticuan.co.id/wp-content/uploads/2025/05/PAKET-JASA-IMPORT-PRIORITAS-copy-2.webp",
    desc_modal:
      "Paket lengkap bagi importir grosir yang ingin mendatangkan barang dalam jumlah besar dengan harga terbaik.",
  ...
  {
    title: "IMPORT FRANCHISOR ALL IN ONE",
    price: "± Rp 1.000.000.000,-",
    image:
      "http://pasticuan.co.id/wp-content/uploads/2025/06/PAKET-JASA-IMPORT-FRANCHISOR-ALL-IN-ONE-copy-1.webp",
    img_modal:
      "http://pasticuan.co.id/wp-content/uploads/2025/06/PAKET-JASA-IMPORT-FRANCHISOR-ALL-IN-ONE-copy-1.webp",
    desc_modal:
      "Paket lengkap bagi importir grosir yang ingin mendatangkan barang dalam jumlah besar dengan harga terbaik.",
...
export const eksportirPackages = [
  {
    title: "EKSPOR UMKM",
    price: "$100.00",
    image:
      "http://pasticuan.co.id/wp-content/uploads/2025/06/PAKET-CUAN-EKSPOR-UMKM-copy.webp",
    img_modal:
      "http://pasticuan.co.id/wp-content/uploads/2025/06/PAKET-CUAN-EKSPOR-UMKM-copy.webp",
    desc_modal:
      "Paket ekspor khusus untuk UMKM yang ingin memulai ekspor skala kecil dengan panduan lengkap dan dukungan logistik.",
  },
];
...
export const allExportPackages = [
  {
    title: "EKSPOR UMKM",
...
export const allMemberPackages = [
  ...
  {
    title: "MEMBER GOLD",
    desc: "Jadi Pengusaha dengan Rp 2.5 Juta! Potensi Income Penjualan 60 Juta & Referral 107 Juta/bulan, Profit 3000%, Support Lengkap dan mendapatkan ribuan set produk impor viral siap jual.",
    desc_modal:
  ...
  {
    title: "MEMBER PLATINUM",
    desc: "Jadi Pengusaha Ekspor-Impor dengan Rp 5 Juta! Maksimalkan potensi income hingga 75 Juta & 128 Juta (referral) per bulan, profit 3000%, dukungan bisnis menyeluruh dan mendapatkan ribuan set produk impor viral siap jual.",
    desc_modal:
  ...
  {
    title: "MEMBER DIAMOND",
    desc: "Pengusaha Ekspor-Impor Dengan Rp 20 Juta! Dapatkan income tak terbatas dari jaringan, potensi penjualan 150 Juta & referral 160 Juta/bulan, profit 3000%, support lengkap dan ribuan set produk impor viral siap jual.",
    desc_modal:
